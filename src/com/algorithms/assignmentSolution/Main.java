...
public class Main 
{
	...
	static MergeSortImplementation mergeSortImplementation = new MergeSortImplementation();
	...
	public static void main(String[] args) 
	{
		...
		while (flag) 
		{
			...
			switch(userChoice) 
			{
				...
				case 1: 
					MergeSortImplementation.display(stock_price);
					break;
		
				case 2:
					MergeSortImplementation.reverse(stock_price);
					break;
